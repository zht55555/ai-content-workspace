...
export class WorkflowEngine {
  ...
  constructor(options: { provider?: ReturnType<typeof getLLMProvider>; workflowRepository?: WorkflowRepository; taskRepository?: TaskRepository; eventPublisher?: WorkflowEventPublisher } = {}) {
