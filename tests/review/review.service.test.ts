...
describe("ReviewService", () => {
  ...
  it("rejects a review whose version belongs to another ContentItem", async () => {
    ...
    await expect(service.createReview({ contentItemId: "11111111-1111-4111-8111-111111111111", contentVersionId: "22222222-2222-4222-8222-222222222222", reviewerId: "33333333-3333-4333-8333-333333333333", decision: "REJECTED" })).rejects.toMatchObject({ code: "CONTENT_NOT_FOUND" });
  });
});
